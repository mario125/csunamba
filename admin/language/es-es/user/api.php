...
$_['text_success'] 			=  '¡Usted ha modificado las APIs exitosamente!';
$_['text_list'] 			=  'Lista de API';
$_['text_add'] 				=  'Agregar API';
$_['text_edit'] 			=  'Editar API';
$_['text_ip'] 				=  'A continuación puede crear una lista de IPs permitidas para acceder a la API. Tu IP actual es %s';
